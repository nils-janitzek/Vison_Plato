...
offsets_UNK['CCD4'] = offsets_UNK['CCD1'].copy()
...
offsets_gradients = dict(CCD1=dict(pre=[0, 0], img=[-10, 10], ove=[-10, 10]),
                         ...
                         CCD3=dict(pre=[0, 0], img=[-10, 10], ove=[-10, 10]),
                         CCD4=dict(pre=[0, 0], img=[-10, 10], ove=[-10, 10]))  # ADU
...
gains = dict(CCD1=3.3, CCD2=3.3, CCD3=3.3, CCD4=3.3)
