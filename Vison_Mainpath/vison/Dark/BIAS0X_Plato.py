...
# END IMPORT
from vison.datamodel.core import vIndex#mod_NJ
...
class BIAS0X(DarkTask):
    ...
    def build_scriptdict(self, diffvalues=dict(), elvis=context.elvis):
        ...
        print("BIAS0X_sdict",BIAS0X_sdict)
        return BIAS0X_sdict
        ...
        **METACODE**
        ...
        if not self.drill:
            ...
            for iObs in range(nObs):
                ...
                for jCCD, CCDk in enumerate(CCDs):
                    ...
                    print("fullccdobj_name"),fullccdobj_name
                    ...
                    for kQ, Q in enumerate(Quads):
                        ...
                        #except ValueError:
                        #    pass
                        #print(ccdobj.prescan,ccdobj.overscan)
                        #print(vstart,vend)
                        _RON = onlyRONimg.std()
        ...
        for jCCD, CCDk in enumerate(CCDs):
            ...
            for kQ, Q in enumerate(Quads):
                ...
                print("CCDk, Q Rh_cq:",CCDk, Q, Rh_cq)
                print("\n")
        print("RON_histos",RON_histos) 
        ...
        #print("self.figdict['B0Xbasic_histosRON'][1]['data']",self.figdict['B0Xbasic_histosRON'][1]['data'])
        print("self.figdict['B0Xbasic_histosRON'][1]['meta']",self.figdict['B0Xbasic_histosRON'][1]['meta'])
...
if __name__ == '__main__':
    ...
    print("Plato_BIAS_Test")
"""

#Path structure
#general
maindir="/lhome/njanitzek/ESTEC/N-analogue_chain_pipeline/VISON/vison/vison/"
taskdir="dark/"
#input/output
datadir="DATA/"
resdir="RESULTS/"
...
#log
logdir="LOG_DATA/"
#logfile="EXP_LOG_120319_test2.txt"
logfile="EXP_LOG_120319_test2.txt"
...
#define inputs
d=dict()
d['explogf']=datadir+missiondir+logdir+logfile
d['datapath']=datadir+missiondir
#d['OBSID_lims']=[0,1e7]
d['OBSID_lims']=[17000,18020]
d['resultspath']=maindir+taskdir+resdir+missiondir
d["CHAMBER"]="A_CBE_AUG18"
d['diffvalues']=dict(col001=dict(frames=25, exptime=0))
d["test"]="BIAS01"
#d["test"]="DARK01"
#d["test"]='MOT_WARM'
d['inCDPs']={}
...
#initialize BIAS0X task object (instance of BIAS0X class)
b=BIAS0X(inputs=d)

#execute subtasks of the BIAS0X task
b.check_data()#checks Explog and HK data
b.prep_data()#prepares CCD input data together with Explog and HK data
b.get_checkstats_ST()#optional subtask but necessary to get the right datadict format for further analysis 
b.check_metrics_ST()#optional subtask but necessary to get the right datadict format for further analysis
b.basic_analysis()#does the actual bias analysis
